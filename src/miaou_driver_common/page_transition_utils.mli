...
(** [handle_next_page page_module st handler] checks if the current page requests
    ...
    - Calls [handler.on_new_page next_module next_state] if transitioning to a valid page
...
val handle_next_page :
  (module PAGE_SIG with type state = 's) -> 's -> 'r handler -> 'r
